...
public interface ReservationSeatRepository extends JpaRepository<ReservationSeat, Long> {
	 ...
	 */
	@Query("SELECT new com.lockers.outerpark.domain.seat.repository.query.SeatStatusInfo("
		...
		+ "AND r.status != 'CANCELLED' "
		+ "AND rs.isDeleted = false")
	List<SeatStatusInfo> findSeatStatusByConcertId(@Param("concertId") Long concertId);
